...
import { VoiceSelector } from "@/components/faceless-shorts/voice-selector";
import { BgMusicSelector } from "@/components/shorts/bg-music-selector";
import { VideoStylePicker } from "@/components/faceless-shorts/video-style-picker";
import { CaptionConfig } from "@/components/shorts/caption-config";
import { MockupPreview } from "@/components/faceless-shorts/mockup-preview";
import { ScriptSection } from "@/components/faceless-shorts/script-section";
import type { AppRouter } from "@/trpc/routers/_app";
import { CaptionStyle } from "@/types";
import { toast } from "sonner";
import AuthModal from "@/components/tools/auth-modal";

export default function FacelessShortsToolUi() {
