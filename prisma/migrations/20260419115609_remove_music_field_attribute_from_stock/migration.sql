/*
  ...
  - The values [MUSIC] on the enum `StockType` will be removed. If these variants are still used in the database, this will fail.

*/
-- AlterEnum
BEGIN;
CREATE TYPE "StockType_new" AS ENUM ('VOICE', 'BG_VIDEO', 'BG_MUSIC', 'AI_AVATAR');
